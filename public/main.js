...
var galvanize = [-105.0070158, 39.7576305]
...
var map = new mapboxgl.Map({
    ...
    center: [galvanize[0], galvanize[1]],
});


directionsAPI = (a) => {
    var end = [a.dataset.lng, a.dataset.lat]
    fetch(`https://api.mapbox.com/directions/v5/mapbox/driving/${galvanize[0]},${galvanize[1]};${a.dataset.lng},${a.dataset.lat}?steps=true&geometries=geojson&access_token=${key2}`)
        .then((response) => {
            return response.json()
                .then((data) => {
